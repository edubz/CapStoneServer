...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 69.0, 23.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 710.0, 160.5, 54.0, 22.0 ],
									"text" : "delay 20"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 368.0, 49.0, 63.0, 22.0 ],
									"text" : "script stop"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 265.0, 49.0, 64.0, 22.0 ],
									"text" : "script start"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 274.5, 72.0, 274.5, 72.0 ],
									"source" : [ "obj-4", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 377.5, 90.0, 274.5, 90.0 ],
									"source" : [ "obj-6", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 171.5, 66.0, 252.0, 66.0, 252.0, 45.0, 274.5, 45.0 ],
									"order" : 7,
									"source" : [ "obj-8", 0 ]
								}
...
, 			{
				"name" : "file5.wav",
				"bootpath" : "~/Documents/capstone2020/CapStoneServer/public/uploads",
				"patcherrelativepath" : "./public/uploads",
				"type" : "WAVE",
				"implicit" : 1
			}
, 			{
